...
async function saveProgressTracker() {
  try {
    ...
    console.log(`Progress tracker saved: ${progressTracker.completed.length}/${totalPrefixes} prefixes completed`);
  } catch (err) {
    ...
    try {
      ...
      const response = await gotScraping({
        ...
        headers: {
          ...
          "sec-ch-ua": BROWSER_CONFIG.secChUa,
          "sec-ch-ua-mobile": BROWSER_CONFIG.secChUaMobile,
          "sec-ch-ua-platform": BROWSER_CONFIG.secChUaPlatform,
